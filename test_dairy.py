...
if __name__ == '__main__':
    ...
    param_data = pd.concat([milk, butter, cheese], axis=1, sort=False)
    param_data.columns = ["milk", "butter", "cheese"]
    ...
    causal_graph_true.add_edge(Edge(GraphNode(param_data.columns[0]), GraphNode(param_data.columns[1]), Endpoint.TAIL, Endpoint.ARROW))
    causal_graph_true.add_edge(Edge(GraphNode(param_data.columns[0]), GraphNode(param_data.columns[2]), Endpoint.TAIL, Endpoint.ARROW))
